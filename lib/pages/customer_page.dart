...
import '../widgets/update_customer_dialog.dart';
...
class _CustomerPageState extends State<CustomerPage> {
  final _cutomerData = CustomerService();
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: _cutomerData.search(_searchQuery),
                    ...
                    return employeeDatas.isEmpty
                        ...
                        : Theme(
                            ...
                            child: PaginatedDataTable(
                              ...
                              source: _DataSource(
                                  employeeDatas, context, updateCustomerDialog),
                            ),
                          );
...
class _DataSource extends DataTableSource {
  ...
  DataRow getRow(int index) {
    ...
    final employeeLocation = datas['latitude'].toString();
    ...
    return DataRow(cells: [
      ...
      DataCell(Text(employeeLocation)),
      DataCell(IconButton(
          onPressed: () {
